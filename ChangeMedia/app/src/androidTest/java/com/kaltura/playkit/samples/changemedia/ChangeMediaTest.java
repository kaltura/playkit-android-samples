    ...
    public void changeMediaTest() {
        ...
        mainActivity.player.addEventListener(new PKEvent.Listener() {
            ...
            public void onEvent(PKEvent event) {
                if (isSecondPlay) {
                    //assertEquals(MainActivity.SECOND_SOURCE_URL, mainActivity.player.getMediaFormat().))
                }
                else {
                    isSecondPlay = true;
                }
        ...
        ViewInteraction appCompatButton4 = onView(
                allOf(withId(R.id.change_media_button), withText("Change media"),
                        childAtPosition(
                                allOf(withId(R.id.activity_main),
                                        childAtPosition(
                                                withId(android.R.id.content),
