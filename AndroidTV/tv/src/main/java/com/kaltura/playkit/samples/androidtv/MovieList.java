...
public final class MovieList {
    ...
    public static List<Movie> setupMovies() {
        ...
        String videoUrl[] = {
                "https://cdnapisec.kaltura.com/p/243342/sp/24334200/playManifest/entryId/0_uka1msg4/flavorIds/1_vqhfu6uy,1_80sohj7p,1_ry9w1l0b/format/applehttp/protocol/https/a.m3u8",
        ...
        list.add(buildMovieInfo("category", title[0],
                description, "Studio Zero", videoUrl[0], cardImageUrl[0], bgImageUrl[0], 60000));
