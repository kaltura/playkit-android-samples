...
public class Consts {
    public static final String ADS_JSON_FILE_URL = "http://externaltests.dev.kaltura.com/playKitApp/adManager/full_demo_ads_custom_inbal.json"; //"https://d3arsss1ejpe8a.cloudfront.net/IMA/full_demo_ads_v7.json";

    public static final String VIDEO_PLAYLIST_FRAGMENT_TAG = "video_playlist_fragment_tag";
    public static final String VIDEO_EXAMPLE_FRAGMENT_TAG = "video_example_fragment_tag";
    public static final String SOURCE_URL11 = "https://cdnapisec.kaltura.com/p/2215841/sp/221584100/playManifest/entryId/1_w9zx2eti/protocol/https/format/applehttp/falvorIds/1_1obpcggb,1_yyuvftfz,1_1xdbzoa6,1_k16ccgto,1_djdf6bk8/a.m3u8";
    public static final String SOURCE_URL1 = "https://playertest.longtailvideo.com/adaptive/eleph-audio/playlist.m3u8";//"http://cdnapi.kaltura.com/p/243342/sp/24334200/playManifest/entryId/0_uka1msg4/flavorIds/1_vqhfu6uy,1_80sohj7p/format/applehttp/protocol/http/a.m3u8";
    ...
    public static final String FIRST_SOURCE_URL = "http://cdnapi.kaltura.com/p/243342/sp/24334200/playManifest/entryId/1_sf5ovm7u/flavorIds/1_d2uwy7vv,1_jl7y56al/format/applehttp/protocol/http/a.m3u8";
    public static final String SECOND_SOURCE_URL = "http://fastly.kastatic.org/KA-youtube-converted/PEeUTQ0Gri8.m3u8/PEeUTQ0Gri8.m3u8";
    public static String HLS_URL = "http://qa-apache-php7.dev.kaltura.com/p/1091/sp/109100/playManifest/entryId/0_ttfy4uu0/flavorIds/0_mwmzcwv0,0_g68ar3sh/format/applehttp/protocol/http/a.m3u8";
    public static String HLS_URL2 = "https://cdnapisec.kaltura.com/p/2215841/sp/2215841/playManifest/entryId/1_ebs5e9cy/flavorIds/1_7fshquo8,1_niqt96wt,1_pnwhqw86,1_jatz0imc/deliveryProfileId/13942/protocol/https/format/applehttp/a.m3u8";
    public static String LIVE_URL = "http://qa-apache-php7.dev.kaltura.com/p/1091/sp/109100/playManifest/entryId/0_nwkp7jtx/format/applehttp/protocol/http/uiConfId/15068781/a.m3u8";
    ...
    public static final String KAVA_BASE_URL = "https://analytics.kaltura.com/api_v3/index.php";

    public static final String ANALYTIC_TRIGGER_INTERVAL = "10";
    public static int DISTANCE_FROM_LIVE_THRESHOLD = 120000; // 2 min


    public static final String LIVE_ENTRY_ID = "0_nwkp7jtx";
    public static final int  LIVE_PARTNER_ID = 1281471;
    public static final int  LIVE_UICONF_ID = 24997472;
    public static int LIVE_DISTANCE_FROM_LIVE_THRESHOLD = 150000; // 2 min


    private static final String HLS_ENTRY_ID = "0_ttfy4uu0";
    public static final int  HLS_PARTNER_ID = 1281471;
    public static final int  HLS_UICONF_ID = 24997472;
    public static int HLS_DISTANCE_FROM_LIVE_THRESHOLD = 150000; // 2 min
}
