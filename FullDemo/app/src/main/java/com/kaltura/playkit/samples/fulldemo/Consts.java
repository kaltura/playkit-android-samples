...
public class Consts {
    public static final String ADS_JSON_FILE_URL = "http://externaltests.dev.kaltura.com/playKitApp/adManager/full_demo_ads_dai_custom.json"; //"https://d3arsss1ejpe8a.cloudfront.net/IMA/full_demo_ads_v7.json";
